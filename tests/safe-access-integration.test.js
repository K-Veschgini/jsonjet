...
describe('Safe Access Integration', () => {
  ...
  it('should handle missing fields gracefully in flows', async () => {
    ...
    try {
      ...
      const flowResult = await queryEngine.executeStatement(
        'create flow safe_test from test_input | project { name: name, missing: missing_field } | insert_into(test_output)'
      );
  ...
  it('should handle null values gracefully', async () => {
    ...
    try {
      ...
      const flowResult = await queryEngine.executeStatement(
        'create flow null_test from null_input | project { name: name } | insert_into(null_output)'
      );
