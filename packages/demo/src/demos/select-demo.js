export const selectDemo = `// JSONJet Select Operator Demo
...
// Note: Compare this to project - select is safer and more powerful:
// - select { ...*, new: computed } vs project { id: id, name: name, new: computed }
// - select { ...*, -sensitive } vs manual field listing  
// - Safe property access built-in`;